...
export function StockMovementTable(props: IProps) {
    ...
    const refreshTable = useCallback(() => {
        ...
        api.StockMovement.List({ stock: props.clickedStock, sort: sort.toUrlString() })
            .then((stocks) => {
                    ...
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell style={{ width: '1px' }}>
                                <TableSortLabel>Valore</TableSortLabel>
                            </TableCell>
...
function TfrChip() {
    return <Chip label="TFR" variant="outlined" size="small" style={{ color: '#70e000', borderColor: '#70e000' }} />;
}
