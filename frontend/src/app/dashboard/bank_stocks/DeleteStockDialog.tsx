...
export default function DeleteStockDialog({ open, onClose, stock }: IProps) {
    ...
    return (
        <Dialog open={open} onClose={onClose}>
            ...
            <DialogTitle>Confermi di voler cancellare l&apos;azione</DialogTitle>
            <DialogContent>
                <DialogContentText>Sei sicuro di voler cancellare l&apos;azione selezionata?</DialogContentText>
            </DialogContent>
            <DialogActions>
