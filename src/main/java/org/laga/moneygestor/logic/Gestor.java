...
public interface Gestor<ID, T> {
     ...
     */
    ID insert(UserGestor userGestor, T object);

    /**
     * Delete object in the database
     * @param id id of object to delete
     */
    default void deleteById(UserGestor userGestor, ID id) {
        deleteById(userGestor, id, false);
    }
     ...
     */
    void deleteById(UserGestor userGestor, ID id, boolean forceDelete);

    /**
     * Update object in database, where id to update is take by object
     * @param newObject new object
     */
    void update(UserGestor userGestor, T newObject);
     ...
     * @param newObject new object
     */
    void update(UserGestor userGestor, ID id, T newObject);
     ...
     */
    T getById(UserGestor userGestor, ID id);

    Stream<T> getAll(UserGestor userGestor);
}
